...
const TestDrawer = React.lazy(() => import('./Screen/Management User/Drawer'));
...
const routes = [
  ...
  { path: '/drawer', name: 'TestDrawer', component: TestDrawer},
  { path: '/member/details/:id', exact: true, name: 'Details', component: UserDetails}
];
